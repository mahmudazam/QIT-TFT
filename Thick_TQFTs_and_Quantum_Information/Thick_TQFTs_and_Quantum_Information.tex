...
\usepackage{\CWD/preamble/preamble}
\usepackage{subfiles}

\AtBeginDocument{
\input{\CWD/frontmatter/title}
\input{\CWD/frontmatter/abstract}
\input{\CWD/frontmatter/frontmatter}
}

\AtEndDocument{
\input{\CWD/ending/references}
}

\begin{document}

\subfile{\CWD/introduction/introduction}

\pagebreak

\subfile{\CWD/first_approach/first_approach}

\pagebreak

\subfile{\CWD/connections/connections}

\pagebreak

\subfile{\CWD/graphs/graphs}

\pagebreak

\subfile{\CWD/field_theory/field_theory}
