...
\TODO{We need to make precise the exact pattern order of the vertices in $G$ and
$H$. We possibly need a total ordering of vertices in each part of each vertex
set.}

\TODO{Need a notion of gluing bundles.}
