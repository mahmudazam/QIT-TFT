...
\cupcob{(0, 2)}
\node at (1.5, 0) (cuplbl) {cup};
\end{tikzpicture}
\qquad \qquad \qquad
\begin{tikzpicture}[scale=0.5]
\capcob{(3, 2)}
\node at (1.5, 0) (caplbl) {cap};
\end{tikzpicture}\]
...
observe some properties of this construction and justify the naming.

We first note that there is some redundancy in this setup. The empty graph, the
...
\TODO{State inverse parallel transport problem}
